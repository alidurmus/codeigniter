...
class Planlama extends MY_Controller
{
    public $viewFolder = "";
    ...
    public function __construct()
    {
        ...
        $this->viewFolder = "planlama";

        $this->load->model("girdikontrol/girdi_kontrol_model");
        $this->load->model("tedarikci/tedarikciler_model");
        $this->load->model("malzeme/malzemeler_model");
    ...
    public function index()
    {
        ...
        $data['girdi_kontrol'] = 'planlama/girdi_kontrol_formu';
        $data['process_kontrol'] = 'planlama/process_form';
        $data['final_kontrol'] = 'planlama/final_kontrol';
        $data['kullanicilar'] = 'planlama/kullanicilar';
        $data['urunler'] = 'planlama/urunler';
        $data['tedarikciler'] = 'planlama/tedarikciler';
        $data['malzemeler'] = 'planlama/malzemeler';
        $data['is_emri_takip'] = 'planlama/is_emri';
        $data['process_takip'] = 'planlama/process_kontrol_cizelge';


        $this->load->view('planlama', $data);
    }
