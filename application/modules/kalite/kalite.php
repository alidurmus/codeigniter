...
class Kalite extends MY_Controller
{
    public $viewFolder = "";
    ...
    public function index()
    {
        ...
        $data['girdi_kontrol'] = 'kalite/girdi_kontrol_formu';
        $data['process_kontrol'] = 'kalite/process_form';
        $data['final_kontrol'] = 'kalite/final_kontrol';
        $data['kullanicilar'] = 'kalite/kullanicilar';
        $data['urunler'] = 'kalite/urunler';
        $data['tedarikciler'] = 'kalite/tedarikciler';
        $data['malzemeler'] = 'kalite/malzemeler';
        $data['is_emri_takip'] = 'kalite/is_emri';
        $data['process_takip'] = 'kalite/process_kontrol_cizelge';


        $this->load->view('kalite', $data);
    }
