            ...
            <table class="table table-striped table-sm"> 
                <tbody>                    
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group"> 
                                <input id="kutu_no"  type="text" class="form-control input-sm"  name="kutu_no"  placeholder="0000"> 
                            </div>
                        </td>
                        <td> </td>
                        <td> </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <div class="input-group"> 
                                <input  type="text" class="form-control input-sm"  name="lot" value="<?php echo ""; ?>" placeholder="0000"> 
                            </div>
                        </td>
                        <td></td>
                        <td></td>
